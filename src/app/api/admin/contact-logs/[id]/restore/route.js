...
/**
 * Ініціалізація Firebase Admin один раз на процес.
 * Підтримує:
 *  - FIREBASE_SERVICE_ACCOUNT_BASE64 (рекомендовано на Windows)
 *  - FIREBASE_SERVICE_ACCOUNT_JSON  (сирий JSON з екранованими \\n у private_key)
...
/** Зручний хелпер: отримати admin auth (ініт виконається автоматично) */
